...
<%
    ...
    boolean op = session.getAttribute("loginID") == null ? false : true;
...
<form>
    <table class="contenttable">
        ...
        <!-- 수정<1> -->
                <input type="button" value="글목록" 
                    onClick="document.location.href=
                    '<%=request.getContextPath()%>/memberone/main.jsp?pageNum=<%=pageNum%>'">
            </td>
        </tr>
    </table>
    <%
    ...
    <script>
    alert("정상적인 접근이 아닙니다.")
    location.replace("/result/memberone/login.jsp")
    </script>
    <% } %>
</form>
</article>
